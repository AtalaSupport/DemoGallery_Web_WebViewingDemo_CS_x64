...
rotatable:!0,
/**
       * @property {boolean} [resizable=true] - Indicates whether annotation could be resized through UI. This property is ignored and considered set to false if noresizeonzoom is set to true.
       */
resizable:!0,
/**
...
/**
   ...
   */function X(e,t,n,o){void 0===o&&(o=!0);var i={};e.multiview?i=e:(e&&e.type&&b[e.type]&&Ke.extend(!0,i,b[e.type]),Ke.extend(!0,i,e));var a=new Ze(h,i,m);a._pageindex=t,a.setFIndex(t);var r=a.get().annotationId;r&&0!==r&&!me(r)||(r=fe()+1,a.setAnnotationId(r)),m.maxAnnotationId<r&&(m.maxAnnotationId=r),void 0===m.annos[t]&&(m.annos[t]=[]),m.annos[t].push(a),pe(r),x.redrawPageFromIndex(t,!0),"function"==typeof n&&n(a),De(a);var l=a.getClonedData();return o&&h.trigger({type:w.annocreate,anno:l,annotation:l,page:t}),a}function G(e,t,n){return X(e,t,n).getClonedData()}function Y(e,t){J(t,e)}
/**
...
/**
   ...
   * _viewer.save(‘’, ‘tif’)
   */function cn(e,t,n,o,i){"function"==typeof n&&(i=o,o=n,n={}),"function"==typeof t&&(i=o,o=t,t=W.savefileformat),"function"==typeof e&&(i=o,o=e,e=null),void 0===t&&(t=W.savefileformat);var a=Wn.extend(!0,n,{atala_subpath:e||"",atala_sformat:t});N.annotations&&Wn.extend(a,{atala_iuname:W.annotations.saveusername,atala_annos:N.annotations.stringifyChanges()}),N.forms&&Wn.extend(a,{atala_forms:N.forms.stringifyChanges()}),N.document&&Wn.extend(a,{atala_document:N.document.stringifyChanges()}),W.savepreviouslysigneddocument&&Wn.extend(a,{atala_savesigned:"true"}),Ut(a,o,i)}
/**
...
/**
   ...
   * @returns {number}
   */
function(){return V()[0]},h.getSelectedPagesIndices=V,h.selectThumb=U,h.deselectThumb=W,h.isActive=D,h.activate=function(){C(f,h.getDocumentInfo())};var H=function(){};function R(){D()&&(y?y.closeDocument(P(),u):f.empty(),M()),j(),v=f=null}var j=function(){};function B(e,t,n,o){w.base&&Ke.each(w.base.dom.pageDivs,function(e,t){t.off(c),t.thumbInitialized=!1}),w.scrolling=!1,w.base&&(w.base.state.prpr=0),null==o&&("function"==typeof t?(o=t,t=null):"function"==typeof n&&(o=n,n=null)),"string"==typeof e&&(y.closeDocument(P(),u),w.viewer.pagenumber=0,w.base&&(w.base.state.scrollPos.x=0,w.base.state.scrollPos.y=0)),N(e,t,n,function(e,t){h.scrollTo(0,0,!1),Fe(e,t,o)})}var N=function(){};function q(e){if(w.base){0===g.length&&g.push(0);for(var t=0;t<w.base.dom.pageDivs.length;t++){var n=0<t?w.base.dom.pageDivs[t-1]:null,o=w.base.dom.pageDivs[t],i=!1;-1<g.indexOf(o._index)&&e?(o.removeClass("atala_grouped_selection"),o.addClass(h.domclasses.atala_active_thumb),o.attr("aria-label").endsWith(" Selected")||o.attr("aria-label",o.attr("aria-label")+" Selected"),null!==n&&-1<g.indexOf(n._index)&&(o.addClass("atala_grouped_selection"),n.addClass("atala_grouped_selection")),i=!0):(o.removeClass(h.domclasses.atala_active_thumb),o.removeClass("atala_grouped_selection"),o.attr("aria-label",o.attr("aria-label").replace(" Selected",""))),Q(o,i)}}}
/** 
